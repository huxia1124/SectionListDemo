...
/*
	...
	A set of classes that hide the difference between GDI+ and Direct2D.

	by Huan Xia.

	Please feel free to use, modify and share this code.

	[Important: this is a development version, not all functions were implemented. There are a lot of bugs as well]
